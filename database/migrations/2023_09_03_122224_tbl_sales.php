...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('tbl_sales', function (Blueprint $table) {
            ...
            $table->decimal('decPreviousPartyBalanceAmt', $precision = 10, $scale = 2)->default(0);
            $table->tinyInteger('isPartyFullPaid')->default(0)->comment('0 = not full paid, 1 = party is full paid the bill amount');
