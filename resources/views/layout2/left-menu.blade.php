	...
	<aside class="app-sidebar">
		<div class="side-header">
			<a class="header-brand1" href="index.html">
				<img src="{{ asset('assets/images/logo/') }}/{{ env('APP_LOGO') }}" class="header-brand-img desktop-logo" alt="logo">
				...
				<img src="{{ asset('assets/images/logo') }}/{{ env('APP_LOGO') }}" class="header-brand-img light-logo1" alt="logo">
			</a><!-- LOGO -->
		</div>
		<ul class="side-menu">
			<li><h3>Main</h3></li>
