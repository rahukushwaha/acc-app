                                                    ...
                                                    <table class="table text-nowrap text-md-nowrap table-bordered" id="myTable">
                                                        ...
                                                        <tfoot>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <input type="text" class="form-control" id="decTotalSubDiscount" name="decTotalSubDiscount" value="0" readonly />
                                                                </td>
                                                                <td>
                                                                    <input type="text" class="form-control" id="decTotalSubTax" name="decTotalSubTax" value="0" readonly />
                                                                </td>
                                                                <td colspan="2">
                                                                    <input type="text" class="form-control" id="decTotalAmount" name="decTotalAmount" value="0" readonly />
                                                                </td>
                                                            </tr>
                                                        </tfoot>
                                                    </table>
                                                ...
                                                <div class="row border-bottom border-info" style="padding-bottom: 0.2rem!important; padding-top: 0.2rem!important;">
                                                    <div class="col-sm-12 col-md-12 col-xl-12">
                                                        <div class="row">
                                                            <div class="col-sm-6 col-md-6">
                                                                <div class="input-group">
                                                                    <span class="input-group-text">+ Additional Chargers</span>
                                                            ...
                                                            <div class="col-sm-6 col-md-6">
                                                                <div class="input-group">
                                                                    <span class="input-group-text">&#8377;</span>
                                                                    <input type="text" class="form-control" id="decAdditionalChargesAmt" name="decAdditionalChargesAmt" value="0.00" style="text-align:right;" />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-xl-12">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-6 col-md-6">
                                                                <div class="input-group">
                                                                    <span class="input-group-text">&#8377;</span>
                                                                    <input type="text" class="form-control" id="decTotalAmt" name="decTotalAmt" value="0.00" style="text-align:right;" />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-xl-12">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-6 col-md-6">
                                                                <div class="input-group">
                                                                    <span class="input-group-text">&#8377;</span>
                                                                    <input type="text" class="form-control" id="decBalanceAmt" name="decBalanceAmt" value="0.00" style="text-align:right;" />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
...
function itemDtlCalc(id, keyName) {
    ...
    if (decDiscountPer > 0 && decAmountTemp > 0 && keyName=="decDiscountPer") {
        descDiscountAmtTemp = parseFloat(decAmountTemp * decDiscountPer / 100);
        $("#decDiscountAmt"+id).val(descDiscountAmtTemp.toFixed(2));
    }
    if (decDiscountPer == "" && keyName=="decDiscountPer") {
        $("#decDiscountAmt"+id).val("");
    }
    /* end discount calc*/
    decAmount = parseFloat(decAmountTemp - descDiscountAmtTemp);
