...
<head>
    ...
    <meta name="description" content="Noa - Demo">
...
<body class="ltr app sidebar-mini">
                ...
                <div class="container-fluid main-container">
                    <div class="d-flex">
                        ...
                        <div class="d-flex order-lg-2 ms-auto header-right-icons">
                            ...
                            <!-- if screen is mobile size then show  -->
                                    ...
                                    <div class="d-flex order-lg-2">
                                        ...
                                        <div class="dropdown d-md-flex profile-1">
                                            <a href="#" data-bs-toggle="dropdown" class="nav-link pe-2 leading-none d-flex animate">
                                                <span>
                                                    <img src="{{ asset('assets/images/faces/13.jpg') }}" alt="profile-user"
                                                        class="avatar  profile-user brround cover-image">
                                                </span>
                                                <div class="text-center p-1 d-flex d-lg-none-max">
                                                    <h6 class="mb-0" id="profile-heading">{{ $UserUtility->getLoggerName() }}<i class="user-angle ms-1 fa fa-angle-down "></i></h6>
                                                </div>
                                            </a>
                                            <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
    ...
    @include('layout.js')
    <script>
        @if(Session::has('successMsgAutoClose'))
            successMsgAutoClose("{{ Session::get('successMsgAutoClose') }} ");
        @endif
        @if(Session::has('successMsg'))
            successMsg("{{ Session::get('successMsg') }} ");
        @endif
        @if(Session::has('warningMsgAutoClose'))
            warningMsgAutoClose("{{ Session::get('warningMsgAutoClose') }} ");
        @endif
        @if(Session::has('warningMsg'))
            warningMsg("{{ Session::get('warningMsg') }} ");
        @endif
        @if(Session::has('dangerMsgAutoClose'))
            dangerMsgAutoClose("{{ Session::get('dangerMsgAutoClose') }} ");
        @endif
        @if(Session::has('dangerMsg'))
            dangerMsg("{{ Session::get('dangerMsg') }} ");
        @endif
    </script>
</body>
</html>
