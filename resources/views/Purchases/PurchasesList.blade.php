                ...
                <div class="card-body border-bottom">
                    <form>
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="vchSupplierNameMobileNo" class="form-label">Supplier Name/Mobile No</label>
                                    <input type="text" class="form-control" id="vchSupplierNameMobileNo" name="vchSupplierNameMobileNo" placeholder="Supplier Name/Moile No">
                                </div>
                            </div>
                        </div>
                        <div class="row">
