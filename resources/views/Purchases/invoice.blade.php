                                                ...
                                                <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                                    <div class="card">
                                                        <div class="card-body" style="padding-top: 5px; padding-bottom: 5px;">
                                                            <label class="fs-25 border-bottom border-info" style="margin-bottom: 0rem">Invoice Form:</label><br />
                                                            <label class="fs-20" style="margin-bottom: 0rem">{{ $purDtl->varSupplierName }}</label><br />
                                                ...
                                                <div class="col-sm-12 col-md-12 col-xl-12">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-12 col-md-6">
                                                            <div class="form-group">
                                                                <label class="form-label">Bill Receipt No.</label>
                                                                <input type="text" class="form-control" value="{{ ($purDtl->varBillReceiptNo=='')?'NA':$purDtl->varBillReceiptNo }}" readonly />
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-12 col-md-6">
